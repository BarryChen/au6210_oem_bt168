...
#define MASK_LCD_SEG	0x00FF
	...
	#define DISP_TYPE	WORD
#else
	#define DISP_TYPE	BYTE
#endif
...
//COM定义
#define LED_COM_PORT_IE		GPIO_D_IE
#define LED_COM_PORT_OE		GPIO_D_OE
#define LED_COM_PORT_OUT	GPIO_D_OUT
#define LED_COM_PORT_PU		GPIO_D_PU
#define LED_COM_PORT_PD		GPIO_D_PD
...
#define LED_SEG_PORT_1P7MA	GPIO_B_ICS_1MA7
#define LED_SEG_PORT_2P4MA	GPIO_B_ICS_2MA4
...
extern BYTE CODE DispIconSet[];
extern DISP_TYPE CODE DispCharSet[];
